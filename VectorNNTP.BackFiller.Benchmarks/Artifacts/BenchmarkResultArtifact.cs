...
internal readonly record struct BenchmarkResultArtifact(
    ...
    double ConfiguredMeasurementSeconds,
    ...
    P1GreetingProvenanceSummary? P1GreetingProvenance)
{
    ...
    internal static BenchmarkResultArtifact From(BenchmarkResult result, TransitBenchmarkConfig config, int processorCount)
    {
        return new BenchmarkResultArtifact(
            ...
            MeasurementSeconds: result.Boundary.MeasurementWindowDuration.TotalSeconds,
            ConfiguredMeasurementSeconds: config.MeasurementDuration.TotalSeconds,
            ...
            OfferedArticles: result.OfferedArticles,
            OfferedGbps: result.OfferedGbps,
            OfferedWithinWindowArticles: result.OfferedWithinWindowArticles,
            OfferedWithinWindowGbps: result.OfferedWithinWindowGbps,
            AdmittedArticles: result.AdmittedArticles,
            AdmittedGbps: result.AdmittedGbps,
            AdmittedWithinWindowArticles: result.AdmittedWithinWindowArticles,
            AdmittedWithinWindowGbps: result.AdmittedWithinWindowGbps,
            AcceptedArticles: result.AcceptedArticles,
            AcceptedGbps: result.AcceptedGbps,
            AcceptedWithinWindowArticles: result.AcceptedWithinWindowArticles,
            AcceptedWithinWindowGbps: result.AcceptedWithinWindowGbps,
            AcceptedPostMeasurementArticles: result.AcceptedPostMeasurementArticles,
            DrainInclusiveAcceptedGbps: result.DrainInclusiveAcceptedGbps,
            RejectedArticles: result.RejectedArticles,
            RejectedWithinWindowArticles: result.RejectedWithinWindowArticles,
            AmbiguousArticles: result.AmbiguousArticles,
            AmbiguousWithinWindowArticles: result.AmbiguousWithinWindowArticles,
            FailedArticles: result.FailedArticles,
            UnavailableArticles: result.UnavailableArticles,
            CanceledArticles: result.CanceledArticles,
            CompletedWithinWindowArticles: result.CompletedWithinWindowArticles,
            CompletedPostMeasurementArticles: result.CompletedPostMeasurementArticles,
    ...
    internal string ToCsv()
    {
        string[] headers =
        [
            "benchmark_build_version","runtime_assembly_version","runtime_assembly_path","assembly_file_version","process_path","working_directory","configuration","platform","target_framework","runtime_identifier","architecture","source_revision","build_timestamp_utc","workload_pregeneration_ms","payload_preparation_ms","message_id_pool_size","message_id_unique_count","message_id_duplicate_count","reusable_payload_bytes","mode","warmup_seconds","measurement_seconds","configured_measurement_seconds","connections","pipeline_depth","dispatch_workers","generator_workers",
            "queue_max_articles","queue_max_bytes","article_target_bytes","producer_queue_target_articles",
            "offered_articles","offered_gbps","offered_within_window_articles","offered_within_window_gbps",
            "admitted_articles","admitted_gbps","admitted_within_window_articles","admitted_within_window_gbps",
            "accepted_articles","accepted_gbps","accepted_within_window_articles","accepted_within_window_gbps","accepted_post_measurement_articles","drain_inclusive_accepted_gbps",
            "rejected_articles","rejected_within_window_articles","ambiguous_articles","ambiguous_within_window_articles","failed_articles","unavailable_articles","canceled_articles","completed_within_window_articles","completed_post_measurement_articles","peak_queue_depth","peak_queue_bytes","peak_dispatcher_in_flight","peak_actual_pending",
        ...
        [
            ...
            MeasurementSeconds.ToString("F6", CultureInfo.InvariantCulture),
            ConfiguredMeasurementSeconds.ToString("F6", CultureInfo.InvariantCulture),
            ...
            OfferedArticles.ToString(CultureInfo.InvariantCulture),
            OfferedGbps.ToString("F4", CultureInfo.InvariantCulture),
            OfferedWithinWindowArticles.ToString(CultureInfo.InvariantCulture),
            OfferedWithinWindowGbps.ToString("F4", CultureInfo.InvariantCulture),
            AdmittedArticles.ToString(CultureInfo.InvariantCulture),
            AdmittedGbps.ToString("F4", CultureInfo.InvariantCulture),
            AdmittedWithinWindowArticles.ToString(CultureInfo.InvariantCulture),
            AdmittedWithinWindowGbps.ToString("F4", CultureInfo.InvariantCulture),
            AcceptedArticles.ToString(CultureInfo.InvariantCulture),
            AcceptedGbps.ToString("F4", CultureInfo.InvariantCulture),
            AcceptedWithinWindowArticles.ToString(CultureInfo.InvariantCulture),
            AcceptedWithinWindowGbps.ToString("F4", CultureInfo.InvariantCulture),
            AcceptedPostMeasurementArticles.ToString(CultureInfo.InvariantCulture),
            DrainInclusiveAcceptedGbps.ToString("F4", CultureInfo.InvariantCulture),
            RejectedArticles.ToString(CultureInfo.InvariantCulture),
            RejectedWithinWindowArticles.ToString(CultureInfo.InvariantCulture),
            AmbiguousArticles.ToString(CultureInfo.InvariantCulture),
            AmbiguousWithinWindowArticles.ToString(CultureInfo.InvariantCulture),
            FailedArticles.ToString(CultureInfo.InvariantCulture),
            UnavailableArticles.ToString(CultureInfo.InvariantCulture),
            CanceledArticles.ToString(CultureInfo.InvariantCulture),
            CompletedWithinWindowArticles.ToString(CultureInfo.InvariantCulture),
            CompletedPostMeasurementArticles.ToString(CultureInfo.InvariantCulture),
