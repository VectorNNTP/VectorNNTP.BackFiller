...
public class ServiceLifecycleTests
{
    ...
    public void TerminalStates_CorrectlyReportProperties()
    {
        ...
        var stoppedLifecycle = new ServiceLifecycle(TimeProvider.System);
        ...
        var faultedLifecycle = new ServiceLifecycle(TimeProvider.System);
    ...
    public void LogSlowPhaseWarning_RejectsInvalidThreshold(int milliseconds)
    {
        // Arrange
        var lifecycle = new ServiceLifecycle(TimeProvider.System);
        var invalidThreshold = TimeSpan.FromMilliseconds(milliseconds);
    ...
    public void LogSlowPhaseWarning_RejectsNullPhaseName()
    {
        // Arrange
        var lifecycle = new ServiceLifecycle(TimeProvider.System);
        var validThreshold = TimeSpan.FromSeconds(5);
    ...
    public void ConcurrentReaders_WithSingleWriter_NoCorruption()
    {
            ...
            var task = Task.Run(() =>
            {
                try
                {
                    while (!cts.Token.IsCancellationRequested)
                    {
                        ...
                        var _ = lifecycle.CurrentState;
                        var __ = lifecycle.IsTerminal;
                        var ___ = lifecycle.IsFaulted;
                        var ____ = lifecycle.TimeInCurrentState;
                        var _____ = lifecycle.TransitionHistory;
                        var ______ = lifecycle.GetSummary();
                    }
                }
                catch (Exception ex)
                {
        ...
        var history = lifecycle.TransitionHistory;
    ...
    public void TransitionHistory_ReturnsSnapshot_NotLiveCollection()
    {
        ...
        var snapshotBefore = lifecycle.TransitionHistory;
        ...
        var snapshotAfter = lifecycle.TransitionHistory;
        ...
        var snapshotFinal = lifecycle.TransitionHistory;
    ...
    public void SubscriberExceptions_AreIsolated_TransitionCompletes()
    {
        // Arrange
        var lifecycle = new ServiceLifecycle(TimeProvider.System);
        var subscriberAInvoked = false;
        var subscriberBInvoked = false;
        var subscriberCInvoked = false;
    ...
    public void ReentrantTransition_FromSubscriber_ThrowsInvalidOperationException()
    {
        ...
        var testLifecycle = new ServiceLifecycle(TimeProvider.System);
    ...
    public void TimeInCurrentState_AdvancesMonotonically()
    {
        ...
        var first = lifecycle.TimeInCurrentState;
        Thread.Sleep(10); // Small delay
        var second = lifecycle.TimeInCurrentState;
        Thread.Sleep(10); // Small delay
        var third = lifecycle.TimeInCurrentState;
    ...
    public void GetSummary_ReturnsValidDiagnostics()
    {
        ...
        var initialSummary = lifecycle.GetSummary();
        ...
        var afterTransitions = lifecycle.GetSummary();
    ...
    public void ConcurrentWriters_OneSucceeds_OtherRejected_StateRemainsCoheren()
    {
        ...
        var lifecycle = new ServiceLifecycle(TimeProvider.System);
        var slowSubscriberDelay = TimeSpan.FromMilliseconds(100);
        var threadBStartedWhileNotifying = false;
        var threadBCompletedNormally = false;
        ...
        var barrier = new Barrier(2); // Synchronize two threads
        ...
        var history = lifecycle.TransitionHistory;
        Assert.True(history.Count == 2 || history.Count == 3,
