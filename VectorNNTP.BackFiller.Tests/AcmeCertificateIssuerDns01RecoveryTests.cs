...
public sealed class AcmeCertificateIssuerDns01RecoveryTests
{
        ...
        bool failChallengeAfterCreate = false)
    {
        ...
        {
            global::System.IO.Directory.Delete(tempDir, recursive: true);
        }
    }
    ...
    private sealed class FakeCloudflareTxtRecordApi : ICloudflareTxtRecordApi
    {
        ...
        public Task DeleteTxtRecordAsync(string zoneId, string recordId, CancellationToken cancellationToken)
        {
            ...
            _records.RemoveAll(record => record.Id == recordId);
    ...
    private sealed class FakeAcmeContextFactory
    {
        public FakeAcmeContextFactory(bool shouldFailValidation, bool shouldFailFinalize, bool failChallengeAfterCreate)
        {
            ShouldFailValidation = shouldFailValidation;
            ShouldFailFinalize = shouldFailFinalize;
            FailChallengeAfterCreate = failChallengeAfterCreate;
        }

        private bool ShouldFailValidation { get; }
        private bool ShouldFailFinalize { get; }
        private bool FailChallengeAfterCreate { get; }
    }
}
