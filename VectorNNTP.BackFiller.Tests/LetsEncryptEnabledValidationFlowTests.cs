...
public class LetsEncryptEnabledValidationFlowTests
{
    ...
    public void ValidateBackFillerOptions_WhenLetsEncryptDisabled_DoesNotRequireAcmeSettings()
    {
        ...
        Assert.DoesNotContain(errors, static e =>
            e.Setting == "BackFiller:LetsEncrypt:AcmeAccountEmail"
            || e.Setting == "BackFiller:LetsEncrypt:AcmeAccountKeyPem"
            || e.Setting == "BackFiller:LetsEncrypt:PfxExportPassword"
            || e.Setting == "BackFiller:LetsEncrypt:RenewalCheckIntervalHours"
            || e.Setting == "BackFiller:LetsEncrypt:RenewalJitterRatio"
            || e.Setting == "BackFiller:LetsEncrypt:RenewBeforeExpiryDays");
    }
    ...
    public void ValidateBackFillerOptions_WhenLetsEncryptDisabled_IgnoresInvalidAcmeAndRenewalSettings()
    {
        ...
        Assert.DoesNotContain(errors, static e =>
            e.Setting == "BackFiller:LetsEncrypt:AcmeAccountEmail"
            || e.Setting == "BackFiller:LetsEncrypt:AcmeAccountKeyPem"
            || e.Setting == "BackFiller:LetsEncrypt:AcmeTransientRetryMaxAttempts"
            || e.Setting == "BackFiller:LetsEncrypt:ClockSkewCheckTtlMinutes"
            || e.Setting == "BackFiller:LetsEncrypt:ClockSkewMaxMinutes"
            || e.Setting == "BackFiller:LetsEncrypt:DnsAuthoritativeNsCacheMinutes"
            || e.Setting == "BackFiller:LetsEncrypt:DnsAuthoritativeQuorumRatio"
            || e.Setting == "BackFiller:LetsEncrypt:DnsPropagationDelaySeconds"
            || e.Setting == "BackFiller:LetsEncrypt:DnsTxtPollIntervalSeconds"
            || e.Setting == "BackFiller:LetsEncrypt:DnsTxtPollTimeoutSeconds"
            || e.Setting == "BackFiller:LetsEncrypt:PfxExportPassword"
            || e.Setting == "BackFiller:LetsEncrypt:RenewalCheckIntervalHours"
            || e.Setting == "BackFiller:LetsEncrypt:RenewalJitterRatio"
            || e.Setting == "BackFiller:LetsEncrypt:RenewBeforeExpiryDays");
