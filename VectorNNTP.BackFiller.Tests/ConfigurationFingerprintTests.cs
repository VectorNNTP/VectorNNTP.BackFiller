...
public class ConfigurationFingerprintTests
{
    ...
    public void WhenConnectionStringsSection_ThenValueBearingEntryIsDetectedAndSanitized()
    {
        ...
        var mainEntry = entries.FirstOrDefault(kv => kv.Key == "ConnectionStrings:Main");
    ...
    /// <summary>
    /// Verifies the critical edge case: quoted password with embedded semicolons is properly parsed and removed.
    /// </summary>
    /// <remarks>
    ...
    {
        // Arrange
        var config1Data = new Dictionary<string, string?>
        {
            ["NNTP:Host"] = "news1.example.com"
        };

        var config2Data = new Dictionary<string, string?>
        {
    ...
    public void CalculateConfigurationFingerprint_ConnectionStringCredentialChangesIgnored_OperationalChangesDetected()
    {
        ...
        var config3Data = new Dictionary<string, string?>
        {
    ...
    public void CalculateConfigurationFingerprint_MalformedVsValid_ProduceDifferentFingerprints()
    {
        ...
        var configMalformedData = new Dictionary<string, string?>
        {
            ["ConnectionStrings:Main"] = "Server=db01;Password=\"unclosed", // Malformed (unclosed quote)
            ["OtherConfig"] = "same"
        };

        var configValidData = new Dictionary<string, string?>
        {
    ...
    public void CalculateConfigurationFingerprint_DnsSuffixCanonicalizationParity_ProducesSameFingerprint()
    {
        ...
        var configCanonical = new Dictionary<string, string?>
        {
            ["BackFiller:DnsSuffix"] = "example.com"
        };

        var configRawEquivalent = new Dictionary<string, string?>
        {
            ["BackFiller:DnsSuffix"] = " Example.COM. "
        };
    ...
    public void CalculateConfigurationFingerprint_ComplexRealWorldScenario()
    {
        ...
        var stagingConfig = new Dictionary<string, string?>
        {
        ...
        var productionSameSecretsConfig = new Dictionary<string, string?>
        {
