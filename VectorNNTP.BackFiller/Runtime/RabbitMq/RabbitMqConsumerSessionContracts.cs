...
internal interface IRabbitMqConsumerSession : IAsyncDisposable
{
    ...
    /// </summary>
    RabbitMqConsumerSessionIdentity Identity { get; }
    ...
    /// </summary>
    long ActiveConnectionGeneration { get; }
...
internal interface IRabbitMqDeliverySink
{
    ...
    ValueTask OnDeliveryAsync(RabbitMqArticleDelivery delivery, CancellationToken cancellationToken);
}
