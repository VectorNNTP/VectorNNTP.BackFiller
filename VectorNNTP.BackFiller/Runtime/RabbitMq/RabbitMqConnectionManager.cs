...
internal sealed partial class RabbitMqConnectionManager : IAsyncDisposable
{
        ...
        IRabbitMqBrokerConnector? connector = null)
    {
        ...
        _connectionName = _options.GetDefaultConnectionName(runtimeOptions.CanonicalBackFillerFqdn);
    ...
    /// </summary>
    internal bool IsReady => _state == RabbitMqInfrastructureState.TopologyReady || _state == RabbitMqInfrastructureState.Connected;
    ...
    internal async Task EnsureConnectedAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                _recoveryTask = Task.Run(RecoveryLoopAsync);
            }
        }
        finally
        {
    ...
    private async Task ConnectCoreAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            _recoveryAttempt = 0;
            Interlocked.Exchange(ref _consecutiveClientRecoveryErrors, 0);
